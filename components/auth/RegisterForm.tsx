...
export const RegisterForm: React.FC<RegisterFormProps> = ({
  ...
  const [formData, setFormData] = useState({
    ...
    fitnessLevel: 'beginner' as 'beginner' | 'intermediate' | 'advanced', // Always set to beginner
    goals: [] as string[],
  });
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const registrationData = {
        ...
        role: (selectedRole as 'member' | 'mentor') || 'member', // Include role from selection
      };
    ...
    <View style={style}>
      ...
      <View style={styles.headerSection}>
        <Text style={styles.title}>
          Let us know <Text style={styles.titleAccent}>you?</Text>
        </Text>
        <Text style={styles.subtitle}>
          This information will be used to create a personalized Tabata workout plan for you.
        </Text>
      </View>

      {/* Sign Up Section */}
      <View style={styles.signupSection}>
        <Text style={styles.sectionTitle}>Sign Up here</Text>
        <Text style={styles.sectionSubtitle}>
          All the best information to fill in.
        </Text>
        ...
        <Text style={styles.preferredNameText}>
          Tell us, what&apos;s your preferred name?
        </Text>
        ...
        <View style={styles.termsContainer}>
          ...
          >
            ...
            <Text style={styles.termsText}>
              I confirm that I have read, understood and agree to Privacy Policy.{'\n'}
              You agree to our Terms of Service and that you have read our Data Policy and Privacy Policy, including our Cookie Use. This data needs only to craft your Tabata workout plan which provides you with security.
            </Text>
          </TouchableOpacity>
        ...
        <View style={styles.submitContainer}>
          <Button
            title={isLoading ? "Creating Account..." : "Submit"}
